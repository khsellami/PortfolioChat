...
//I need to implement the model here
...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage("Hello there 👋🏻,<br><br>My name is <span class='bold'><a class='alink'>Khadija Sellami</a>.</span><br><br>I am an IT && data student at <span class='bold'>Morocco, ENSA Khouribga 👨🏻‍💻📚</span><br><br>I am eager to hear about potential career opportunities, so I would be pleased to chat about job openings in the engineering sphere.<br><br>Send <span class='bold'>'help'</span> to know more about me.<br>");
            }, 2000);
            break;
        case "help":
        ...
        case "new":
            sendTextMessage(addressString);
            break;
        //here i must modify it in case of another command get response from open ai
        default:
            setTimeout(() => {
                sendTextMessage("Hey I couldn't catch you...😢<br>Send 'help' to know more about usage.");
            }, 2000);
            // const openAIResponse = await getOpenAIResponse(inputText);
            // sendTextMessage(openAIResponse);
            break;
    }
